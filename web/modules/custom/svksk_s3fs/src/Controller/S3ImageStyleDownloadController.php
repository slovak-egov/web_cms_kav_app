...
use Drupal\svksk_s3fs\S3FileDownloadService;
 ...
 */
class S3ImageStyleDownloadController extends ImageStyleDownloadController {
   ...
   */
  public function __construct(LockBackendInterface $lock, ImageFactory $image_factory, StreamWrapperManagerInterface $stream_wrapper_manager, FileSystemInterface $file_system = NULL, S3FileDownloadServiceInterface $s3_file_download_service) {
  ...
  /**
   * Generates an Amazon S3 derivative, given a style and image path.
   *
   * Only used for public or s3 schemes. Private scheme use the normal workflow:
  ...
  public function deliver(Request $request, $scheme, ImageStyleInterface $image_style) {
    ...
    if ($success) {
      ...
      return $this->S3FileDownloadService->download($image_style_uri);
    }
    else {
