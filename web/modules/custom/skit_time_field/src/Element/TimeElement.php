...
namespace Drupal\skit_time_field\Element;
...
class TimeElement extends FormElement {
  ...
  public static function valueCallback(&$element, $input, FormStateInterface $form_state) {
    ...
    if (!empty($input)) {
      ...
      return $time->formatForWidget($element['#show_seconds']);
    }
   ...
   *
   * @see \Drupal\skit_time_field\Plugin\Field\FieldWidget\TimeWidget::formElement()
   */
