...
/**
 * Defines Interval Type list values entity.
 *
 * @ingroup svksk_list_values
 *
 * @ContentEntityType(
 *   id = "lv_interval_type",
 *   label = @Translation("LV Interval Type"),
 *   handlers = {
 ...
 *     },
 *   },
 *   base_table = "lv_interval_type",
 *   data_table = "lv_interval_type_field_data",
 *   translatable = TRUE,
 ...
 * )
 */
class LvIntervalType extends LvBase {
