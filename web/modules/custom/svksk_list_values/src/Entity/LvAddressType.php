...
/**
 * Defines Addess Type list values entity.
 *
 * @ingroup svksk_list_values
 *
 * @ContentEntityType(
 *   id = "lv_address_type",
 *   label = @Translation("LV Address Type"),
 *   handlers = {
 ...
 *     },
 *   },
 *   base_table = "lv_address_type",
 *   data_table = "lv_address_type_field_data",
 *   translatable = TRUE,
 ...
 * )
 */
class LvAddressType extends LvBase {
